...
const GetImage = ({ onHandleChange, title, name, value = [], viewOnly = false, disabled = false, }) => {
...
const MemoizedGetImage = react_1.default.memo(GetImage);
exports.default = MemoizedGetImage;
