...
const GetAudio = ({ onHandleChange, title, name, value = [], viewOnly = false, disabled = false, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { position: "relative", marginTop: 20 }, children: [!viewOnly && ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: "16px" }, children: [(0, jsx_runtime_1.jsx)(InputBox_1.default, { name: name, value: currentValue.mp3, handleChange: handleChange.bind(this, "mp3"), label: `${title} (*.mp3)`, disabled: disabled, type: "search", customStyle: { flex: 3 }, handleKeyDown: keyDown }), (0, jsx_runtime_1.jsx)(InputBox_1.default, { name: name, value: currentValue.ogg, handleChange: handleChange.bind(this, "ogg"), label: `${title} (*.ogg)`, disabled: disabled, type: "search", customStyle: { flex: 3 }, handleKeyDown: keyDown }), (0, jsx_runtime_1.jsx)(ButtonBox_1.default, { type: "button", label: "Add", handleClick: handleSubmit, customBtnStyle: { height: "50px" }, customStyle: { marginTop: 0, marginBottom: 0 } })] }) })), (value === null || value === void 0 ? void 0 : value.length) > 0 && ((0, jsx_runtime_1.jsxs)("div", { style: {
                    border: "1px solid",
                    padding: "10px",
