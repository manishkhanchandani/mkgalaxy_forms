...
const GetFile = ({ onHandleChange, title, name, value = [], viewOnly = false, disabled = false, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "common common-get file-box", style: { position: "relative", marginTop: 20 }, children: [!viewOnly && ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: "16px" }, children: [(0, jsx_runtime_1.jsx)(InputBox_1.default, { name: name, value: currentValue, handleChange: (_name, value) => {
                    ...
                    boxShadow: "5px 10px 8px 10px #888888",
                            ...
                            return ((0, jsx_runtime_1.jsxs)("div", { style: { marginBottom: "40px" }, children: [(0, jsx_runtime_1.jsx)("div", { style: {
                                            overflow: "hidden",
                                            textOverflow: "ellipsis",
                                            whiteSpace: "nowrap",
                                        }, children: (0, jsx_runtime_1.jsx)("a", { href: item.value, target: "_blank", rel: "noreferrer", children: item.value }) }), !viewOnly && ((0, jsx_runtime_1.jsx)("div", { className: "text-center", style: {
                                            color: "blue",
                                            cursor: "pointer",
                                            marginBottom: "1.2em",
...
exports.default = react_1.default.memo(GetFile);
