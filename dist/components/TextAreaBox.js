...
const TextAreaBox = ({ name, label, value, handleChange, handleKeyDown, handleBlur, disabled, type = "text", helperText, error, start, end, maxRows, htmlInputs, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: { marginBottom: "20px", marginTop: "20px" }, children: (0, jsx_runtime_1.jsx)(TextField_1.default, { sx: { boxShadow: "none" }, fullWidth: true, type: type, label: label, name: name, value: value, onKeyDown: handleKeyDown, multiline: true, maxRows: maxRows, onChange: (e) => {
