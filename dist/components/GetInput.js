...
const GetInput = ({ onHandleChange, title, name, value = [], viewOnly = false, disabled = false, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "common common-get input", style: { position: "relative", marginTop: 20 }, children: [!viewOnly && ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: "16px" }, children: [(0, jsx_runtime_1.jsx)(InputBox_1.default, { name: name, value: currentValue, handleChange: (_name, value) => {
