...
const ButtonBox = ({ variant = "contained", label, fullWidth = true, type = "button", handleClick, disabled = false, className = "", color = "secondary", customStyle = {}, customBtnStyle = {}, }) => {
    return ((0, jsx_runtime_1.jsx)("div", { style: Object.assign({ marginBottom: "0.5rem", marginTop: "0.5rem", flex: 1 }, customStyle), children: (0, jsx_runtime_1.jsx)(Button_1.default, { variant: variant, fullWidth: fullWidth, type: type, onClick: () => {
